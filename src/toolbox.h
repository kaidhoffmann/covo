...
// ==========================================================
template <typename T>
inline void subtract_vectors(std::vector<T> &total_sum, std::vector<T> &to_subtract)
{
    std::transform(
...
// ==========================================================
template <typename T>
inline void sum_vectors(std::vector<T> &total_sum, std::vector<T> &to_add)
{
...
// ==========================================================
template <typename T>
inline void divide_vectors(std::vector<T> &numerator, std::vector<T> &denominator)
{
    std::transform(
...
// ==========================================================
template <typename T>
inline double vabs(const std::vector<T> vec)
{
...
// ==========================================================
template <typename T>
inline T periodic_distance(T dr, T Lbox, T r_max)
{
    if (dr >= r_max)
    {
        dr -= Lbox;
...
// ==========================================================
template <typename T>
inline std::vector<T> sphere_to_cart(const std::vector<T> pos_sphere)
{
...
// ==========================================================
template <typename T>
inline std::vector<T> cart_to_sphere(const std::vector<T> pos_cart)
{

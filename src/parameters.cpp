...
void parameters::print()
{
    ...
    int Njk = 1;
    for (int i = 0; i < numb_jk_cart.size(); i++)
    {
        Njk *= numb_jk_cart[i];
    }
    ...
    if (mode == "shell")
    {
        ...
        if (!auto_limits || make_rand)
        {
            ...
            std::cout << "# theta_lim: ";
            for (int i = 0; i < theta_lim.size(); i++)
            {
                std::cout << theta_lim[i] * 180. / M_PI << " ";
            }
            std::cout << std::endl;

            std::cout << "# phi_lim: ";
            for (int i = 0; i < phi_lim.size(); i++)
            {
                std::cout << phi_lim[i] * 180. / M_PI << " ";
            }
            std::cout << std::endl;
        }
    ...
    std::cout << "# - vector a: ";
    for (int i = 0; i < cols_vec_a.size(); i++)
    {
        std::cout << cols_vec_a[i] << " ";
    }
    std::cout << std::endl;

    std::cout << "# - vector b: ";
    for (int i = 0; i < cols_vec_b.size(); i++)
    {
        std::cout << cols_vec_b[i] << " ";
    }
    std::cout << std::endl;
    std::cout << std::endl;
